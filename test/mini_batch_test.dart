...
void main() {
  ...
  int countminiWin = 0;
  for (int i = 0; i < 100; i++) {
    GradientDescent miniGd =
        GradientDescent(initPosition: dr.last, star: star.last, batchSize: 2);
    ...
    double fullToCorrected = degrees(
            ans.greatCircleDistanceTo(Position(radians(27.5), radians(179)))) *
        60;
